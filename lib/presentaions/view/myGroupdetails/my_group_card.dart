...
import 'package:event_app/presentaions/view/group_events.dart/main_group_events.dart';
    ...
    return GestureDetector(
      ...
      child: Column(
        children: [
                        ...
                        GestureDetector(
                            onTap: () {
                              ...
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: ((context) => const GroupEvents()),
                                ),
                              );
                            },
                            child: Container(
          ...
          const SizedBox(height: EnvDimension.big)
